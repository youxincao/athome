...
<head>
	<meta charset="UTF-8">
	<title>登录</title>
	<script type="text/javascript" charset="UTF-8" src="/athome/Public/js/prefixfree.min.js"></script>
<style type="text/css">
body {
   background: url(/athome/Public/img/bg.png);
...
.login-form:before {
    ...
    background:#fff url("/athome/Public/img/profilepicture.jpg") no-repeat 2px 2px;
}
.not-registered {
    position:absolute;
...
@font-face {
  font-family: 'loginform-icon';
  src: url("/athome/Public/font/loginform-icon.eot");
  src: url("/athome/Public/font/loginform-icon.eot?#iefix") format('embedded-opentype'),
       url("/athome/Public/font/loginform-icon.woff") format('woff'),
       url("/athome/Public/font/loginform-icon.ttf") format('truetype'),
       url("/athome/Public/font/loginform-icon.svg#loginform-icon") format('svg');
  font-weight: normal;
  font-style: normal;
}
</style>
